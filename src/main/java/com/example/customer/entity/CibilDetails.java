...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "Customer_Cibil_Score_Details")
public class CibilDetails 
{
	@Id
	@SequenceGenerator(name = "Customer_CibilId", sequenceName = "Customer_CibilId", allocationSize = 1, initialValue =101)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "Customer_CibilId")
